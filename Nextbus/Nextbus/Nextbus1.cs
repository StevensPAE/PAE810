...
//                XmlElement myDocElement = webRequest("http://webservices.nextbus.com/service/publicXMLFeed?command=agencyList").DocumentElement;
...
//                XmlDocument xmlDoc= webRequest(myCommand).OwnerDocument;  //RouteAtts
                
//                Route myRoute = agencyList[AgencyNum].busRoutes[RouteNum];


//                // create a xdocument and parse the response text into it
//                XDocument xDoc = webRequestDoc(myCommand);
//                // the root's first node is the route
//                XElement xRoute = xDoc.Root.FirstNode as XElement;

//                Route RouteA = new Route(xRoute);

//                // same thing using xmldocument
//                XmlDocument doc = new XmlDocument();
//                doc.LoadXml(responseText);
//                // the body's first child is the route
//                XmlElement xmlRoute = doc.DocumentElement.FirstChild as XmlElement;
//                Route RouteB = new Route(xmlRoute);
...
//        private XDocument webRequestDoc(string command)
//        {
//            // Create the web request  
...
//            return XDocument.Parse(myStreamResponse);
//        }
